...
const TopPlayerStats = ({username, focusedStats, selectedMatch}) => {
  ...
  return (
    <div id='stats-section' className='h-full grid grid-rows-[40px_4fr_2fr] min-h-0'>
        <div className='stats-bg h-full w-full grid grid-cols-2'>
            <div className='relative-center small-text font-bold'>Top 500</div>
            <div className='relative-center small-text font-bold'>Player</div>
        </div>
        <div className='stats-bg relative grid grid-rows-4' style={{borderBottom: '1px solid purple'}}>
            <div className='grid grid-rows-[30px_1fr]'>
                ...
                <div className='relative-center grid grid-cols-2'>
                    <div className='relative-center text-fit italic'>{focusedStats?.top_map_winrate ? focusedStats.top_map_winrate.toFixed(2) : '0.00'}</div>
                    <div className='relative-center text-fit italic' 
            ...
            <div className='grid grid-rows-[30px_1fr]'>
                ...
                <div className='relative-center italic grid grid-cols-2'>
                    <div className='relative-center text-fit italic'>{focusedStats?.top_map_pickrate ? focusedStats?.top_map_pickrate?.toFixed(2) : '0.00'}</div>
                    <div className='relative-center text-fit italic'
            ...
            <div className='grid grid-rows-[30px_1fr]'>
                ...
                <div className='relative-center italic grid grid-cols-2'>
                    <div className='relative-center text-fit italic'>{focusedStats?.top_mode_winrate ? focusedStats?.top_mode_winrate?.toFixed(2) : '0.00'}</div>
                    <div className='relative-center text-fit italic'
            ...
            <div className='grid grid-rows-[30px_1fr]'>
                ...
                <div className='relative-center italic grid grid-cols-2'>
                    <div className='relative-center text-fit italic'>{focusedStats?.top_mode_pickrate ? focusedStats?.top_mode_pickrate?.toFixed(2) : '0.00'}</div>
                    <div className='relative-center text-fit italic'
        ...
        <div className='grid grid-cols-2'>
            ...
            <div className='relative-center text-fit font-bold italic'>{stats.grade}</div>
        </div>
    </div>
  )
}
