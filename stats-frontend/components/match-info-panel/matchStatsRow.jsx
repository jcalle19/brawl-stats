    ...
    return (
        <div className='relative w-full h-full min-h-0 grid grid-rows-[1fr_3fr_3fr] pt-2 pb-0 pr-2 font-bold tracking-wider'>
            ...
            <div className='relative grid grid-cols-5 row-start-3 gap-3'>
                ...
                <div className='stats-bg aspect-square rounded overflow-hidden team-box'>
                    <BrawlIcons src={portraitURLs[selected?.team2?.brawler.name]} width={'100%'} size={portraitSize}/>
                </div>
                <div className='stats-bg aspect-square rounded overflow-hidden enemy-box'>
                    <BrawlIcons src={portraitURLs[selected?.enemy1?.brawler.name]} width={'100%'} size={portraitSize}/>
                </div>
                <div className='stats-bg aspect-square rounded overflow-hidden enemy-box'>
                    <BrawlIcons src={portraitURLs[selected?.enemy2?.brawler.name]} width={'100%'} size={portraitSize}/>
                </div>
                <div className='stats-bg aspect-square rounded overflow-hidden enemy-box'>
                    <BrawlIcons src={portraitURLs[selected?.enemy3?.brawler.name]} width={'100%'} size={portraitSize}/>
                </div>
            </div>
