...
const PlayerRow = ({selected}) => {
    ...
    const commonTraits = 'min-h-[100px] shrink-0 aspect-square rounded-[5px] overflow-hidden test-border'
  ...
  return (
    <div className='stats-bg h-full w-full md:min-w-fit md:flex md:justify-center md:overflow-x-auto grid grid-cols-3 grid-rows-2 md:grid-rows-1 md:grid-cols-6 gap-8 p-4 md:p-2 test-border'>
